...
function artfolio_scripts() {
    ...
    /* Slider scripts */
    wp_enqueue_script( 'camera', get_template_directory_uri() . '/js/camera.min.js' );
    ...
    wp_enqueue_script( 'jquery-easing', get_template_directory_uri() . '/js/jquery.easing.1.3.min.js', array( 'jquery' ) );
